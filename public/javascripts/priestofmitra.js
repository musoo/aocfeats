...
return [
    ...
    // 45
    new Feat(2, 7, 4, 49, 2, null,
        new FeatDescription('Undying Belief',
            [
                {s:[-40, -80], suf: 's', t: 'Decreast recast time on Sustaining Faith'}
            ],
            "Reduces the reuse time of the Sustaining Faith prayer.")),
    // 46
    new Feat(2, 7, 5, 54, 5, null,
